...
export function AppearanceSection() {
  ...
  return (
    <div className="flex flex-col gap-7">
      ...
      <div>
        <h3 className="text-white/45 text-[11px] font-semibold tracking-widest uppercase mb-3 flex items-center gap-2">
          <Sliders size={12} /> Opacité des cards
        </h3>
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-white/50 text-sm w-10 text-right tabular-nums">
      ...
      <div>
        ...
        {background.mode === 'solid' && (
          <div className="flex items-center gap-3">
            <label className="text-white/45 text-xs w-16">Couleur</label>
            <input
              type="color"
        ...
        {background.mode === 'gradient' && (
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <label className="text-white/45 text-xs w-16">Couleur 1</label>
              <input
                type="color"
            ...
            <div className="flex items-center gap-3">
              <label className="text-white/45 text-xs w-16">Couleur 2</label>
              <input
                type="color"
            ...
            <div className="flex items-center gap-3">
              <label className="text-white/45 text-xs w-16">Angle</label>
              <input
                type="range"
                min={0}
                max={360}
        ...
        {background.mode === 'image' && (
          <ImageBackgroundPicker background={background} setBackground={setBackground} />
        )}
        {background.mode === 'image' && (
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <label className="text-white/45 text-xs w-16">Overlay</label>
              <input
                type="range"
                min={0}
                max={100}
                ...
                className="flex-1 accent-blue-500"
              />
              <span className="text-white/40 text-xs w-8 tabular-nums">
                {Math.round((background.overlayOpacity ?? 0.5) * 100)}%
              </span>
            </div>
          </div>
        )}
