...
export function FlowersPanel() {
  ...
  const stats = [
    {
      labelKey: 'panels.flowers_panel.soilMoisture',
    ...
    {
      labelKey: 'panels.flowers_panel.temperature',
    ...
    {
      labelKey: 'panels.flowers_panel.brightness',
    ...
    {
      labelKey: 'panels.flowers_panel.humidity',
  ...
  return (
    <Panel title={t('panels.flowers_panel.title')} icon={<Flower2 size={18} />}>
              ...
              <div key={labelKey} className='gc rounded-xl p-3'>
                ...
                {(low || high) && (
                  <div className='text-xs text-orange-400 mt-0.5'>
                    {low ? t('panels.flowers_panel.tooLow') : t('panels.flowers_panel.tooHigh')}
                  </div>
                )}
              </div>
            );
      ...
      <p className='text-white/20 text-xs text-center'>{t('panels.flowers_panel.configHint')}</p>
    </Panel>
  );
}
